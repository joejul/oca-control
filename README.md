...
ddev exec php api/bin/seed.php                  # crea admin "joe" (PIN PIN_REDACTADO) + colaboradores
...
(`PIN_REDACTADO`, fijado directo en la base) que no sigue este formato porque el login no valida
